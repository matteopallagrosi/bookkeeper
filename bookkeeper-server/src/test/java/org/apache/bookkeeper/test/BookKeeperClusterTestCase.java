//CLASSE ORIGINALE DI BOOKKEEPER UTILIZZATA PER CREARE UN CLUSTER DI BOOKIE E NODI ZOOKEEPER LOCALI DA USARE PER IL TESTING
 ...
 */
public class BookKeeperClusterTestCase {
    ...
    public BookKeeperClusterTestCase(int numBookies, int numOfZKNodes) {
