 ...
 */
public abstract class BookKeeperClusterTest {
    ...
    public BookKeeperClusterTest(int numBookies) {
        this(numBookies, 120);
    }

    public BookKeeperClusterTest(int numBookies, int testTimeoutSecs) {
        this(numBookies, 1, testTimeoutSecs);
    }

    public BookKeeperClusterTest(int numBookies, int numOfZKNodes, int testTimeoutSecs) {
